    ...
    M.prototype.config = {
        ...
        u.on("mousemove", function (e) {
            ...
            var e = t(this).prev(), i = a.layBody.find('input[name="layTableCheckbox"]'),
                l = e.parents("tr").eq(0).data("templates.index"), n = e[0].checked,
            ...
            var e = t(this), i = this.value, l = e.parent().data("field"),
                n = e.parents("tr").eq(0).data("templates.index"), o = d.cache[a.key][n];
            o[l] = i, layui.event.call(this, s, "edit(" + f + ")", {value: i, data: o, field: l})
        }).on("blur", "." + N, function () {
            var e, l = t(this), n = l.parent().data("field"), o = l.parents("tr").eq(0).data("templates.index"),
                r = d.cache[a.key][o];
            ...
            var e = t(this), l = e.parents("tr").eq(0).data("templates.index"),
                n = a.layBody.find('tr[data-index="' + l + '"]'), o = "layui-table-click", r = d.cache[a.key][l];
